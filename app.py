...
X_train_s = np.load(f"{MODEL_DIR}/X_train_s.npy")
psi_train = np.load(f"{MODEL_DIR}/psi_train.npy") # Load pre-computed training states
dqn_agent = tf.keras.models.load_model(
    f"{MODEL_DIR}/dqn_agent_model.h5", 
